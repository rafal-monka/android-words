...
public class GlobalVariables {
    static String CONST_SERVER = "http://nodejs-words-git-apps.apps.ca-central-1.starter.openshift-online.com"; //app.os.user1@gmail.com
    ...
    //static String CONST_SERVER = "http://localhost:8085";
    ...
    static String WordsUrlBuyList = "http://react-shoplist-apps1.apps.us-west-1.starter.openshift-online.com/buylists"; //monka.rafal.geoloc@gmail.com
